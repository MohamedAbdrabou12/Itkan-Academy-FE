...
export const navLinks = [
  ...
  },
  {
    ...
    permissions: [PermissionKeys.STAFF_EVALUATION_VIEW],
  },
  {
    id: "kpi-templates",
    title: "قوالب التقييم",
  ...
  {
    id: "enrolments",
    title: "سجلات التحاق للطلاب",
    icon: LucideFileText,
    url: "/itkan-dashboard/enrolments",
    permissions: [PermissionKeys.ACADEMIC_ENROLMENTS_VIEW],
  },
  {
    id: "enrolment-pricing-plans",
    title: "خطط الدفع لالتحاق الطلاب",
    icon: Coins,
    url: "/itkan-dashboard/enrolment-pricing-plans",
    permissions: [PermissionKeys.ACADEMIC_ENROLMENT_PRICING_PLANS_VIEW],
  },
];
