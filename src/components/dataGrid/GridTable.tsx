      ...
      <table className="min-w-full divide-y divide-gray-200">
        <thead className="bg-gray-50">
          <tr>
            {columns.map((column) => {
              ...
              return (
                <th
                  ...
                  className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-700 bg-gray-100"
                  style={{ width: column.width }}
                >
                  {isSortable ? (
                    <button
                      onClick={() => onSort(String(column.key))}
                      className="flex items-center space-x-2 w-full text-left group hover:text-gray-900"
                    >
            ...
            {hasActions && (
              <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-700 bg-gray-100">
